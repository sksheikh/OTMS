...
//        return CourseCategory::orderBy('id','DESC')->get();
    ...
    {
        CourseCategory::updateOrcreateCourseCategory($request);
        return redirect()->route('course-categories.index')->with('success','Course Catgeory Deleted Successfully');
    }
    ...
    {
        CourseCategory::updateOrcreateCourseCategory($request,$id);
